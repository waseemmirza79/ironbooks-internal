                  ...
                  {!confirmDisconnect ? (
                    ...
                    <div className="space-y-2">
                      <div className="text-xs text-red-800 font-semibold">
                        Confirm: revoke SNAP' access to {selected.client_name}'s Stripe?
                      </div>
...
function buildEmailHtml(firstName: string, url: string, clientName: string) {
  ...
  <div style="border:1px solid ${BRAND.border};border-top:none;padding:24px 22px;border-radius:0 0 10px 10px;background:${BRAND.white};">
    ...
    <div style="text-align:center;margin:24px 0;">
      <a href="${url}" style="display:inline-block;background:${BRAND.stripe};color:${BRAND.white};font-weight:600;font-size:15px;padding:14px 28px;border-radius:8px;text-decoration:none;">Connect Stripe to SNAP &rarr;</a>
    </div>
    <div style="background:${BRAND.tealLighter};border:1px solid ${BRAND.border};border-radius:8px;padding:14px 16px;margin:18px 0;">
      ...
      <ul style="margin:0;padding-left:18px;color:${BRAND.slate};font-size:13px;line-height:1.6;">
        ...
        <li><strong style="color:${BRAND.navy};">No charges, no transfers</strong> — SNAP won't issue refunds, move money, or charge your customers</li>
    ...
    <p style="margin:14px 0 0 0;color:${BRAND.navy};line-height:1.55;">Kindly,<br>SNAP</p>
...
What this gives us:
  ...
  • No charges, no transfers — SNAP won't issue refunds, move money, or charge your customers
