...
import { Search, FileSpreadsheet, ArrowRight, CheckCircle2 } from "lucide-react";
...
export function BsCoaPicker({ clientLinks }: { clientLinks: ClientLink[] }) {
  ...
  function open(c: ClientLink) {
    ...
    router.push(`/balance-sheet/${c.id}/coa`);
  }
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-ink-slate mt-0.5">
              ...
              opens the full live BS chart of accounts with edit + reclass actions
            </p>
          </div>
        </div>
