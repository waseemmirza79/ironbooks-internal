        ...
        <div className="space-y-2 mb-6">
          {[
            ...
            },
            {
              ...
              icon: ListChecks,
              title: "COA audit",
              desc: "How close each client's QuickBooks chart is to the master COA · conformance % · cleanup stage · triage for the standardization pass (now open to all bookkeeping staff)",
            },
            {
